...
function App() {
  ...
  const url = `https://api.openweathermap.org/data/2.5/weather?q=${location}&appid=03f77b1b3cf019c473cac06b6b542ca4`
      ...
      <div className="container">
        ...
        <div className="top">
          ...
          <div className="description">
            {data.weather ? <img className="icon" src={`http://openweathermap.org/img/wn/${data.weather[0].icon}@2x.png`}/> : null}
